import { ForgeResizeObserverCallback } from '@tylertech/forge-core';
...
export interface IOverflowMenuCore {
  // todo define getters and setters here
}

export class OverflowMenuCore implements IOverflowMenuCore {
  ...
  constructor(private _adapter: IOverflowMenuAdapter) {
    ...
    this._filteredOptions = () =>
      this._options.filter(option => {
        return this._buttons[option.value].overflow === true;
      });
  }
